  ...
  <div class="max-wl-xl mx-auto">
    ...
    >
      <div
        v-if="post.retweetedByAuthUser"
        class="text-gray-400 font-bold d-flex mb-1"
      >
        Retweeted by
        {{ post.retweetedByAuthUser ? "me" : "" }}
      </div>
        ...
        <div class="flex flex-wrap justify-start items-start w-full">
          <div class="flex item-center">
            <div class="flex-1 flex items-center">
              <h3 class="mr-2 font-bold hover:underline hover:bg-gray-100">
  ...
  export default {
    ...
    mounted() {
      this.channel.listen("LikeEvent", (e) => {
        ...
        this.$store.dispatch("updatePostViaEvent", e.post);
      ...
      this.retweets.listen("RetweetEvent", (e) => {
        console.log("EVENT");
        this.$store.dispatch("retweetPostByEvent", e.post);
      });
    },
